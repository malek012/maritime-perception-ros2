...
Iterative Bounding Box Refinement: Employs cascading network heads with progressively stricter Intersection over Union (IoU) thresholds (0.5 → 0.6 → 0.7) to achieve extreme localization accuracy.
